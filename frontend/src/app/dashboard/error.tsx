    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-xl">
        <div className="mx-auto grid h-16 w-16 place-items-center rounded-full bg-red-50 mb-4">
          <LayoutDashboard className="h-8 w-8 text-red-400" />
        </div>
        <h2 className="text-xl font-bold text-slate-800 mb-2">Dashboard error</h2>
        <p className="text-sm text-slate-500 mb-6">Something went wrong loading the dashboard. This is usually temporary.</p>
