...
const LEVEL_DISPLAY: Record<string, { label: string; bg: string; text: string; ring: string }> = {
  ...
  hu_partner:        { label: 'HU Partner',        bg: 'bg-purple-50',  text: 'text-purple-700',  ring: 'ring-purple-400' },
  hu_trader:         { label: 'HU Trader',         bg: 'bg-fuchsia-50', text: 'text-fuchsia-700', ring: 'ring-fuchsia-400' },
