...
CREATE TABLE IF NOT EXISTS customer_notes (
  ...
  approval_status TEXT NOT NULL DEFAULT 'pending_rm_approval' CHECK (approval_status IN ('pending_rm_approval', 'approved', 'rejected')),
...
CREATE INDEX IF NOT EXISTS idx_customer_note_entries_note_id_created_at ON customer_note_entries(note_id, created_at);
CREATE INDEX IF NOT EXISTS idx_customer_note_entries_created_by_user_id ON customer_note_entries(created_by_user_id);
